        ...
        night.goto(item)
             ...
             .evaluate(function(){
                ...
                try{
                    ...
                    // let openTime = document.querySelectorAll('.micro-timesopen span')[2].querySelector('span').querySelectorAll('span')[0].innerHTML;
                    // let closeTime = document.querySelectorAll('.micro-timesopen span')[2].querySelector('span').querySelectorAll('span')[1].innerHTML;
...
nightmare
    ...
    .click('.signin')
    .wait(1000)
    .type('#Email','systemec2017@gmail.com')
